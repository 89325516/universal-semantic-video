...
| 2026-05-21 | CI runtime maintenance check. | GitHub Actions workflow updated to use Node 24 and opt JavaScript actions into the Node 24 runtime. |
...
| 2026-05-21 | CI-Runtime-Wartungscheck. | GitHub-Actions-Workflow auf Node 24 aktualisiert und JavaScript Actions fuer Node-24-Runtime aktiviert. |
